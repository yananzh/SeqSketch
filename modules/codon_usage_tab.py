...
class CodonUsageTab(QWidget):
    ...
    def _show_help(self):
        help_text = self.tr(
            ...
            "<li><b>GC/Neutrality</b> — bar chart of GC(All)/GC1/GC2/GC3/GC12 for the selected sequence, plus a GC12 vs GC3 neutrality plot (slope ≈ 1 = neutral evolution; slope &lt; 1 = selective constraint)</li>"
            ...
            "<li><b>2 - Vertebrate Mitochondrial</b> — UGA = Trp (not stop), AUA = Met, AGA/AGG = Stop</li>"
            ...
            "<li>With multiple sequences a selector appears and the <b>Compare</b> tab gives per-sequence summaries and the Nc plot</li>"
