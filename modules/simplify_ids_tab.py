from PyQt6.QtWidgets import (QVBoxLayout, QHBoxLayout, QLabel, QLineEdit, QPushButton, QFileDialog, QSizePolicy)
    ...
    def run_simplify(self):
        ...
        try:
            ...
            if not processor.save_file(output_path):
                ...
                self.set_running_state(False)
                return
            self.log_message(f"Simplification complete! Saved to: {output_path}", "INFO")
