...
def create_menus(window):
    ...
    sanger_action = QAction(translations.tr("桑格测序数据处理"), window)
    sanger_action.triggered.connect(window.open_sanger_tab)
    dna_menu.addAction(sanger_action)
    # 3. 蛋白质序列分析
    protein_menu = menubar.addMenu(translations.tr("蛋白质序列分析"))
    # 1. 氨基酸组成
    aa_comp_action = QAction(translations.tr("氨基酸组成"), window)
    aa_comp_action.triggered.connect(window.open_amino_acid_composition_tab)
    protein_menu.addAction(aa_comp_action)
    # 2. 物化性质计算
    physchem_action = QAction(translations.tr("物化性质计算"), window)
    ...
    # 3. 二级结构预测（子菜单）
    sec_struct_menu = QMenu(translations.tr("二级结构预测"), window)
    ...
    # 4. 三级结构预测（子菜单）
    tert_struct_menu = QMenu(translations.tr("三级结构预测"), window)
    ...
    # 5. 结构域预测（子菜单）
    domain_menu = QMenu(translations.tr("结构域预测"), window)
    ...
    # 6. 信号肽预测（子菜单）
    signal_menu = QMenu(translations.tr("信号肽预测"), window)
    ...
    # 7. 跨膜螺旋预测（子菜单）
    tmhmm_menu = QMenu(translations.tr("跨膜螺旋预测"), window)
    ...
    # 8. 同源蛋白搜索（子菜单）
    homolog_menu = QMenu(translations.tr("同源蛋白搜索"), window)
    ...
    # 9. 结构相似蛋白搜索（子菜单）
    structure_similarity_menu = QMenu(translations.tr("结构相似蛋白搜索"), window)
    ...
    # 4. 序列比对
    align_menu = menubar.addMenu(translations.tr("序列比对"))
    # 1. 双序列比对 (在线工具) (子菜单)
    pairwise_align_menu = QMenu(translations.tr("双序列比对 (在线工具)"), window)
    ...
    # 2. 多序列比对 (在线工具) (子菜单)
    multiple_align_menu = QMenu(translations.tr("多序列比对 (在线工具)"), window)
    ...
    # 3. 序列标识图 (在线工具) (子菜单)
    seq_logo_menu = QMenu(translations.tr("序列标识图 (在线工具)"), window)
    ...
    # 5. BLAST分析
    blast_menu = menubar.addMenu(translations.tr("BLAST分析"))
    # NCBI在线BLAST
    ncbi_blast_action = QAction(translations.tr("NCBI在线BLAST"), window)
    ncbi_blast_action.triggered.connect(window.open_ncbi_blast_web)
    blast_menu.addAction(ncbi_blast_action)
    # 本地BLAST子菜单
    local_blast_menu = QMenu(translations.tr("本地BLAST"), window)
    make_db_action = QAction(translations.tr("1. 构建BLAST数据库..."), window)
    make_db_action.triggered.connect(window.open_blast_make_db_dialog)
    local_blast_menu.addAction(make_db_action)
    run_blast_action = QAction(translations.tr("2. 运行BLAST查询..."), window)
    ...
    # 6. 引物设计
    primer_menu = menubar.addMenu(translations.tr("引物设计"))
    open_primer_action = QAction(translations.tr("PCR 引物设计助手"), window)
    ...
    # 7. 进化树构建与可视化
    evolution_menu = menubar.addMenu(translations.tr("进化树构建与可视化"))
    # 7.1 系统发育树构建（在线工具）子菜单
    phylo_build_menu = QMenu(translations.tr("系统发育树构建(在线工具)"), window)
    ...
    # 7.2 进化树可视化（在线工具）子菜单
    phylo_vis_menu = QMenu(translations.tr("进化树可视化（在线工具）"), window)
    ...
    # 8. 收藏夹系统
    fav_menu = menubar.addMenu(translations.tr("收藏夹"))
    manage_fav_action = QAction(translations.tr("管理收藏夹"), window)
    ...
    # 设置菜单
    settings_menu = menubar.addMenu(translations.tr("设置"))
    
    # 1. 外观主题 (子菜单)
    theme_menu = QMenu(translations.tr("外观主题"), window)
    light_action = QAction(translations.tr("浅色主题"), window)
    dark_action = QAction(translations.tr("深色主题"), window)
    ...
    # 2. 界面语言 (子菜单)
    lang_menu = QMenu(translations.tr("界面语言"), window)
