...
def create_menus(window):
    ...
    msa_menu = QMenu(window.tr("Multiple Sequence Alignment"), window)
    ...
    open_cloning_action = QAction(window.tr("Cloning Primer Design"), window)
    ...
    toytree_vis_action = QAction(window.tr("Tree Visualization (Toytree)"), window)
